...
class _WikipediaApiClient implements WikipediaApiClient {
  ...
  Future<WikipediaArticle> getRandomArticle(String languageCode) async {
    ...
    final _options = _setStreamType<WikipediaArticle>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'https://${languageCode}.wikipedia.org/api/rest_v1/page/random/summary',
    ...
    late WikipediaArticle _value;
    try {
      _value = WikipediaArticle.fromJson(_result.data!);
    } on Object catch (e, s) {
